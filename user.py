...
class User:
    ...
    def update_first_name(self):
        while True:
            new_first_name = input("Please enter your new first name or type 'EXIT' to quit: ").strip()
            if new_first_name.upper() == 'EXIT':
    ...
    def update_last_name(self):
        while True:
            new_last_name = input("Please enter your new last name or type 'EXIT' to quit: ").strip()
            if new_last_name.upper() == 'EXIT':
                print("Exiting without updating details.")
                break
            else:
